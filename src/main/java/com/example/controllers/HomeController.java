...
/*
    + Запилить помещение
    + Проверить помещение валюты
    + Запилить все названия валют в выпадающих списках на странице
    + Запилить расчет вылюты
    + Запилить в поле ввода только цифры или цифры с точнок
    + Добавить Российский рубль в БД
    + Запилить стирание истории конвертаций по кнопке
    + Запилить сохранения истории изменений
    + Запилить изменение валюты в БД для валют в зависимости от даты
    + При обновлении таблицы смотреть дату в ЦБ и если та дата раньше текущей, то не обновляем данные
    + Запилить сохранение в истории только разных валют
    + Запилить получение валюты по ID, а не перебором
    + Запилить поиск по истории валют

    - Запилить сохранение валют в полях после обновления страницы
